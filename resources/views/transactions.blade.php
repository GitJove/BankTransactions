        ...
        <div class="panel-heading">Transactions</div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        <div class="col-md-6" style="padding-left: 0;">
                            ...
                            {{ csrf_field() }}
                                <div class="form-group">
                                    ...
                                    <input type="text" name="deposit" class="form-control" id="exampleInputEmail2" aria-describedby="emailHelp2" placeholder="Enter deposit amount" value="{{ old('deposit') }}">
                            ...
                            {{ csrf_field() }}
                                <div class="form-group">
                                    ...
                                    <input type="text" name="withdraw" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter withdraw amount" value="{{ old('withdraw') }}">
                    ...
                    <a class="btn btn-primary" href="{{route('report')}}" style="float:right;">Report preview</a>
